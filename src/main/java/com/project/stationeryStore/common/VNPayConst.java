package com.project.stationeryStore.common;
...
public class VNPayConst {
	...
	public static String vnp_TmnCode = "QI1VNFY5"; //Mã website của merchant trên hệ thống của VNPAY. Ví dụ: 2QXUI4J4
	public static String vnp_CurrCode = "VND";
	public static String vnp_Locale = "vn";
	public static String vnp_OrderType = "100000";
	public static String vnp_ReturnUrl = "http://localhost:8080/stationery-store/api/payment/payment-callback";
	public static String vnp_HashSecret = "NQQPZZOBQWNVLKQRFHEQTVZUCUZXFMBB";
